  ...
  describe('When logged in', function () {
    ...
    describe('When blog is created', function () {
      ...
      it('A blog can be liked', function () {
        ...
        cy.get('@blog')
          .findByTestId('blog_likes')
          .should('contain', `likes ${this.likes + 1}`)
      })
      ...
      it('Blogs are ordered in correct order initially and after changing number of likes', function () {
        ...
        cy.addNewBlog({
          title: titleFirstBlog,
          author: authorFirstBlog,
          url: urlFirstBlog,
          likes: likesFirstBlog,
        })
        ...
        cy.addNewBlog({
          title: titleSecondBlog,
          author: authorSecondBlog,
          url: urlSecondBlog,
          likes: likesSecondBlog,
        })
        ...
        cy.contains(`${titleLastBlog} ${authorLastBlog}`)
          .parent()
          .as('lastBlog')
        ...
        cy.get('@lastBlog')
          .findByTestId('blog_likes')
          .should('contain', `likes ${likesLastBlog + 1}`)
        cy.get('@lastBlog').findByTestId('blog_like_button').click()
        cy.get('@lastBlog')
          .findByTestId('blog_likes')
          .should('contain', `likes ${likesLastBlog + 2}`)
        cy.findAllByTestId('blog_info').eq(0).should('contain', titleFirstBlog)
