...
import { BrowserRouter as Router, Routes, Route, Link, useParams, useMatch, useNavigate, renderMatches } from 'react-router-dom'
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input {...content.validFieldProps} />
        </div>
        <div>
          author
          <input {...author.validFieldProps} />
        </div>
        <div>
          url for more info
          <input {...info.validFieldProps} />
        </div>
